...
public class Suino extends Animal implements ICuidadosMamiferos, ICuidadosGerais {
    ...
    public void status() {
        if (this.getSexo() == "F") {
            System.out.println("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
            System.out.println("####### STATUS SUÍNA #######");
            System.out.println("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
            ...
            if (this.getGestante() == true) {
                ...
                System.out.println("Idade inferior à 1 ano, porca não gestante.");
            }
            System.out.println("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
        } else if (this.getSexo() == "M") {
            System.out.println("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
            System.out.println("####### STATUS SUÍNO #######");
            System.out.println("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
            System.out.println("Sexo: " + this.getSexo());
            System.out.println("Idade: " + this.calcularIdadeAnimalTotal());
            //System.out.println("Total Meses de vida: " + this.calcularIdadeAnimalMeses());
